...
def evaluate_resume():
    try:
        ...
        Percentage Match: Indicate the overall match percentage between the resume and the job description. Consider the relevance and frequency of keywords, the alignment of skills and experience, and the presence of required qualifications.
        Missing Keywords: Identify any critical keywords that are absent from the resume but present in the job description. These could include specific technical skills, tools, methodologies, certifications, and job-specific terminology.
        Profile Summary: Offer a concise summary of the candidate's profile based on the resume content. Highlight key qualifications, experience, skills, and any notable achievements that are relevant to the job description.
